...
The MCP catalog currently contains 35 MCP tools. `dbt-nova tool call` is the
...
| `tool call <tool_name>` | 35 MCP tools | Equivalent | - | CLI tool-call mode supports the canonical MCP tool catalog. |
