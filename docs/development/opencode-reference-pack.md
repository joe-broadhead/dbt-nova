...
| `evals/reviewer.yml` | repo eval suite | Nova evals | Provider-backed reviewer coverage for semantic bypass, unsafe raw joins, and freshness caveat checks. |
